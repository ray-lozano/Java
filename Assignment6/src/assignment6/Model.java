...
public class Model
{
      ...
      public static void arraySort(Card[] cardArray, int arraySize)
      {
         for(int i = 0; i < arraySize; ++i)
         {
            for(int j = 0; j < arraySize; ++j)
            {
               ...
               else if(cardArray[j] == null) return;
            }
         }
      }
    ...
    //Public Methods
      ...
      public void shuffle()
      {
       ...
       //Copy the temp array back to the main array
         for (int i = 0; i < temp.length; ++i) cards[i] = temp[i];             
      }
      ...
      public Card inspectCard(int k)
      {
         ...
         else return new Card('e', cards[k].getSuit());
      }
   ...
   public static class CardGameOutline
   {
      ...
      public Hand getHand(int k)
      {
         ...
         if (k < 0 || k >= numPlayers) return new Hand();
         return hand[k];
      }
